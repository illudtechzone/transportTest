...
public class ReviewResource {
    ...
    private static final String ENTITY_NAME = "transportReview";
    ...
    public ResponseEntity<ReviewDTO> createReview(@RequestBody ReviewDTO reviewDTO) throws URISyntaxException {
        ...
        if (reviewDTO.getId() == null) {
            throw new BadRequestAlertException("already exist ID", ENTITY_NAME, "idexists");
        } 
        ReviewDTO result1 = reviewService.save(result);
