...
public class TransportQueryResource {
	...
	public ResponseEntity<DataResponse> getTasks(@RequestParam(value = "name", required = false) String name,
		...
		return transportqueryService.getTasks(name, nameLike, description, priority, minimumPriority, maximumPriority,
	...
	public List<OpenBookings> getAllOpenBookings(@RequestParam(value = "name", required = false) String name,
		...
		return transportqueryService.getAllOpenBookings(name, assignee, assigneeLike, processInstanceId,processDefinitionId,
				processDefinitionKey);
	}
	
	@GetMapping("/getAllPendingBookings")
	public List<OpenBookings> getAllPendingBookings(@RequestParam(value = "name", required = false) String name,
			@RequestParam(value = "nameLike", required = false) String nameLike,
			@RequestParam(value = "assignee", required = false) String assignee,
			@RequestParam(value = "assigneeLike", required = false) String assigneeLike,
			@RequestParam(value = "candidateUser", required = false) String candidateUser,
		...
		return transportqueryService.getAllPendingBookings(name,nameLike,assignee,assigneeLike,candidateUser,candidateGroup,candidateGroups,processInstanceId,processDefinitionId,processDefinitionKey,createdOn, createdBefore, createdAfter);
		
	}

	@DeleteMapping("/process-instances/{processInstanceId}")
	ResponseEntity<Void> deleteProcessInstance(@PathVariable(value = "processInstanceId")String processInstanceId) {
		return transportqueryService.deleteProcessInstance(processInstanceId);
