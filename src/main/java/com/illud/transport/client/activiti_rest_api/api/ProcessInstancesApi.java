...
import com.illud.transport.client.activiti_rest_api.model.ProcessInstanceActionRequest;
import com.illud.transport.client.activiti_rest_api.model.ProcessInstanceCreateRequest;
import com.illud.transport.client.activiti_rest_api.model.ProcessInstanceQueryRequest;
import com.illud.transport.client.activiti_rest_api.model.ProcessInstanceResponse;
import com.illud.transport.client.activiti_rest_api.model.RestIdentityLink;
...
public interface ProcessInstancesApi {
    ...
    @RequestMapping(value = "/runtime/process-instances",
        produces = "application/json", 
        method = RequestMethod.GET)
    ResponseEntity<DataResponse> getProcessInstances(@ApiParam(value = "Only return models with the given version.") @Valid @RequestParam(value = "id", required = false) String id,
    		@ApiParam(value = "Only return process instances with the given process definition key.") @Valid @RequestParam(value = "processDefinitionKey", required = false) String processDefinitionKey,
    		@ApiParam(value = "Only return process instances with the given process definition id.") @Valid @RequestParam(value = "processDefinitionId", required = false) String processDefinitionId,
    		@ApiParam(value = "Only return process instances with the given businessKey.") @Valid @RequestParam(value = "businessKey", required = false) String businessKey,
    		@ApiParam(value = "Only return process instances in which the given user is involved.") @Valid @RequestParam(value = "involvedUser", required = false) String involvedUser,
    		@ApiParam(value = "If true, only return process instance which are suspended. If false, only return process instances which are not suspended (active).") @Valid @RequestParam(value = "suspended", required = false) Boolean suspended,
    		@ApiParam(value = "Only return process instances which have the given super process-instance id (for processes that have a call-activities).") @Valid @RequestParam(value = "superProcessInstanceId", required = false) String superProcessInstanceId,
    		@ApiParam(value = "Only return process instances which have the given sub process-instance id (for processes started as a call-activity).") @Valid @RequestParam(value = "subProcessInstanceId", required = false) String subProcessInstanceId,
    		@ApiParam(value = "Return only process instances which aren�t sub processes.") @Valid @RequestParam(value = "excludeSubprocesses", required = false) Boolean excludeSubprocesses,
    		...
    		@ApiParam(value = "Only return process instances with the given tenantId.") @Valid @RequestParam(value = "tenantId", required = false) String tenantId,
    		@ApiParam(value = "Only return process instances with a tenantId like the given value.") @Valid @RequestParam(value = "tenantIdLike", required = false) String tenantIdLike,
    		@ApiParam(value = "If true, only returns process instances without a tenantId set. If false, the withoutTenantId parameter is ignored.") @Valid @RequestParam(value = "withoutTenantId", required = false) Boolean withoutTenantId,
    		@ApiParam(value = "Property to sort on, to be used together with the order.", allowableValues = "id, processDefinitionId, tenantId, processDefinitionKey") @Valid @RequestParam(value = "sort", required = false) String sort);
