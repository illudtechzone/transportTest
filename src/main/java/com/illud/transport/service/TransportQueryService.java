...
public interface TransportQueryService {
	...
	List<OpenBookings> getAllOpenBookings(String name, String assignee, String assigneeLike,
			String processInstanceId, 
			@Valid String processDefinitionId, @Valid String processDefinitionKey);

	ResponseEntity<Void> deleteProcessInstance(String processInstanceId);

	List<OpenBookings> getAllPendingBookings(String name, String nameLike, String assignee, String assigneeLike,
