...
public class ReviewResourceIntTest {
     ...
     *
     * @see com.illud.transport.repository.search.ReviewSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createReview() throws Exception {
        ...
        assertThat(testReview.getiDPcode()).isEqualTo(DEFAULT_I_D_PCODE);
    ...
    public void updateReview() throws Exception {
        ...
        Review testReview = reviewList.get(reviewList.size() - 1);
        assertThat(testReview.getiDPcode()).isEqualTo(UPDATED_I_D_PCODE);
